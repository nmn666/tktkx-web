...
const HOME_SCHEMA = {
  ...
  "@graph": [
    {
      "@type": "Organization",
      "@id": "https://www.tktkx.cn/#organization",
      "name": "速锋科技",
      "alternateName": "TKTKX",
      "url": "https://www.tktkx.cn",
      "logo": {
      ...
      "contactPoint": [
        {
          ...
          "identifier": "WeChat: SFTKTKTK"
        },
        {
          "@type": "ContactPoint",
          "contactType": "customer support",
          "availableLanguage": ["Chinese", "English"],
          "identifier": "Telegram: @TKTKGOOD",
          "url": "https://t.me/TKTKGOOD"
        }
      ]
    },
    {
      "@type": "WebSite",
      "@id": "https://www.tktkx.cn/#website",
      "url": "https://www.tktkx.cn",
      "name": "速锋科技 - 跨境电商出海专家",
      "publisher": { "@id": "https://www.tktkx.cn/#organization" }
    },
    {
      "@type": "Service",
      "name": "TikTok 账号陪跑服务",
      "provider": { "@id": "https://www.tktkx.cn/#organization" },
      "description": "从0到1的全程TikTok运营陪跑，涵盖账号诊断、内容创作、橱窗开通、数据分析。",
      "areaServed": "Global"
    },
    {
      "@type": "Service",
      "name": "GEO 生成式引擎优化",
      "provider": { "@id": "https://www.tktkx.cn/#organization" },
      "description": "让品牌在DeepSeek、ChatGPT、豆包等AI大模型回答中被主动引用推荐。",
      "url": "https://www.tktkx.cn/geo-marketing"
    },

    {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "2026年开通TikTok橱窗的核心要求是什么？",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "核心要求包括：1. 账号注册满30天（满月号）；2. 粉丝数量达到1000位；3. 账号处于良好的合规状态。速锋科技提供专业的满月号和千粉号，帮助您快速跨越门槛。"
          }
        },
        {
          "@type": "Question",
          "name": "什么是GEO优化？速锋科技的GEO服务有什么用？",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "GEO（生成式引擎优化）是AI搜索时代的新型营销方式。当用户向DeepSeek、豆包、ChatGPT等AI提问时，AI会主动引用并推荐经过GEO优化的品牌和产品。速锋科技提供专业GEO优化服务，覆盖8大国内外AI平台。"
          }
        }
      ]
    }
...
// Force rebuild 2026-04-16 - Enhanced GEO Schema
export default function Home() {
  ...
  useEffect(() => {
    ...
    el.textContent = JSON.stringify(HOME_SCHEMA);
    return () => {
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="pt-6 border-t border-gray-100 space-y-3">
               ...
               <a
                 ...
                 target="_blank"
                 rel="noopener noreferrer"
                 className="flex items-center p-4 bg-[#0088cc] text-white rounded-2xl shadow-lg font-bold justify-center"
               >
                  <span className="mr-2 text-lg">✈️</span> Telegram @TKTKGOOD
               </a>
            </div>
          </div>
        </div>
            ...
            <div className="flex flex-col md:flex-row items-center">
              ...
              >
                ...
                <div className="mt-4 flex flex-wrap gap-3">
                  <div className="inline-flex items-center gap-2 bg-green-50 border border-green-200 rounded-full px-5 py-2 text-sm font-medium text-green-800">
                    <span className="text-base">💬</span>
                    微信：<span className="font-bold tracking-wide">SFTKTKTK</span>
                  </div>
                  <a
                    href="https://t.me/TKTKGOOD"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 bg-sky-50 border border-sky-200 rounded-full px-5 py-2 text-sm font-medium text-sky-800 hover:bg-sky-100 transition-colors"
                  >
                    <span className="text-base">✈️</span>
                    Telegram：<span className="font-bold tracking-wide">@TKTKGOOD</span>
                  </a>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <div className="space-y-6">
                  ...
                  >
                    <div className="bg-sky-100 p-3 rounded-full mr-4 group-hover:bg-sky-200 transition-colors">
                      <span className="text-xl leading-none">✈️</span>
                    </div>
                    <div>
                      <p className="font-semibold group-hover:text-sky-700 transition-colors">Telegram 飞机号</p>
                      <p className="text-[#0088cc] font-bold">@TKTKGOOD</p>
                    </div>
                  </a>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            {[
              ...
              },
              {
                title: "联系方式",
                links: [
                  { text: "微信：SFTKTKTK", url: "https://work.weixin.qq.com/kfid/kfc6e7a2a71db64e56d" },
                  { text: "Telegram：@TKTKGOOD", url: "https://t.me/TKTKGOOD" },
                  { text: "在线客服", url: "#联系我们" },
                  { text: "GEO优化咨询", url: "/geo-marketing" },
                  { text: "工作时间 9:00-22:00" }
                ]
              }
            ].map((column, index) => (
              <div key={index}>
